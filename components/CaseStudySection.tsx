      ...
      <section className="relative bg-white py-16 sm:py-20 lg:py-24 overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 mb-16 lg:mb-20 items-center">
            ...
            {/* GIF rechts – nur Fade + Containment */}
            <motion.div
              ...
              initial={{ opacity: 0 }}                 // keine Translate-Animation ums Iframe
            ...
            >
              <div className="relative">
                <iframe
                  id="js_video_iframe_azim"
                  title="Case Reel: Azim (Jumpshare)"
                  src="https://jumpshare.com/embed/BYDSN3sP6sXDLaEapj9w?hideTitle=true&disableDownload=true"
                  frameBorder={0}
                  allowFullScreen
                  width="300"
                  height="533"
                  ...
                  loading="lazy"
                  // fetchpriority="high"  // ← falls above-the-fold
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center">
            {/* GIF links – nur Fade + Containment */}
            <motion.div
            ...
            >
              <div className="relative">
                <iframe
                  id="js_video_iframe_kedro"
                  title="Case Reel: Kedro (Jumpshare)"
                  src="https://jumpshare.com/embed/06NwIz8ze4v9HBhf9jVT?hideTitle=true&disableDownload=true"
                  frameBorder={0}
                  allowFullScreen
                  width="300"
                  height="533"
