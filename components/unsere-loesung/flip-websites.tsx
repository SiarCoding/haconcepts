...
const websites = [
  ...
  { 
    ...
    url: 'https://simon-hauer-immobilien.de', 
    button: 'Website besuchen', 
...
export const HeroParallax = ({
  ...
  const translateY = useSpring(
    useTransform(scrollYProgress, [0, 0.2], [isMobile ? -100 : -700, isMobile ? 200 : 500]),
    springConfig
  );
  ...
  return (
    <div
      ref={ref}
      className="flip-websites h-[150vh] sm:h-[200vh] md:h-[250vh] lg:h-[300vh] py-10 sm:py-20 md:py-32 lg:py-40 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d] bg-black"
    >
      ...
      <motion.div
        ...
        className="w-full"
      >
        <motion.div className="flex flex-row-reverse space-x-reverse space-x-2 sm:space-x-4 md:space-x-8 lg:space-x-12 xl:space-x-20 mb-4 sm:mb-8 md:mb-12 lg:mb-16 xl:mb-20 justify-center px-2 sm:px-4">
        ...
        <motion.div className="flex flex-row space-x-2 sm:space-x-4 md:space-x-8 lg:space-x-12 xl:space-x-20 mb-4 sm:mb-8 md:mb-12 lg:mb-16 xl:mb-20 justify-center px-2 sm:px-4">
